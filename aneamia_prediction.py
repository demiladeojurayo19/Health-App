...
with open('anaemia.pkl', 'rb') as file:
    loaded_model = pickle.load(file)


def anaemia_prediction():
    ...
    data_collected = {
        ...
        'high_blood_pressure': [high_blood_pressure_value],  # Add a comma here
    ...
    if prediction == 1:
        output = 'you have anaemia'
    else:
        output = 'you do not have anaemia'
